                            ...
                            <x-adminlte-card class="col-md-12" theme-mode="full">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-center">
                                        <x-adminlte-button class="btn-flat col-sm-2" type="submit" label="Kirim"
                    ...
                    onClose: function(selectedDates, dateStr, instance) {
                        ...
                        if (startDate && endDate) {
                            ...
                            if (diffDays != maxRange) {
                                ...
                                Swal.fire({
                                    type: 'warning',
                                    title: 'Melebihi Rentang Maksimum / Minimum',
                                    text: `Rentang yang diizinkan adalah ${maxRange} hari.`,
